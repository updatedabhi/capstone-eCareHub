...
-->
    ...
    <li><a class="dropdown-item" href="{{ route('booking.status') }}">Booking Status</a></li>
    <li><a class="dropdown-item" href="#">eCare-store</a></li>
    <li><a class="dropdown-item" href="#">Meet Online</a></li>
</ul>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-12 ms-auto mt-4 mt-lg-0">
                        <p class="copyright-text">Copyright © eCareHub 20224 
                    </div>
